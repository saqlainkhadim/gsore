                                ...
                                <ul class="header__top-content--right user-set-role d-flex">
                                    <li class="user-currency pos-relative">
                                        ...
                                        <ul class="expand-dropdown-menu dropdown-menu" >
                                            <li><a href="#"><img src="{{URL::asset('front')}}/assets/img/icon/flag/icon_usa.png" alt="">English</a></li>
                                            <li><a href="#"><img src="{{URL::asset('front')}}/assets/img/icon/flag/icon_france.png" alt="">French</a></li>
                                        </ul>
                                    </li>
                        ...
                        <div class="col-12 d-flex justify-content-between align-items-center">
                            ...
                            <div class="header__logo">
                                <a href="{{('/')}}" class="header__logo-link img-responsive">
                                    <img class="header__logo-img img-fluid" src="{{URL::asset('front')}}/assets/img/logo/logo.png" alt="">
                                </a>
                            </div> <!-- End Logo -->
                             <!-- Start Header Menu -->
                                ...
                                <nav>
                                    <ul class="header__nav">
                                                ...
                                                <li class="mega-menu__box">
                                                    ...
                                                    <div class="mega-menu__item-box">
                                                        ...
                                                        <ul class="mega-menu__item">
                                                            <li class="mega-menu__list"><a href="{{('/shop-sidebar-grid-left')}}" class="mega-menu__link">Grid Left Sidebar</a></li>
                                                            <li class="mega-menu__list pos-relative">
                                                                <a href="{{('/shop-sidebar-grid-right')}}" class="mega-menu__link">Grid Right Sidebar</a>
                                                                <span class="menu-label menu-label--red">New</span>
                                                            </li>
                                                            <li class="mega-menu__list"><a href="{{('/shop-sidebar-full-width')}}" class="mega-menu__link">Full Width</a></li>
                                                    ...
                                                    <div class="mega-menu__item-box">
                                                        ...
                                                        <ul class="mega-menu__item">
                                                            <li class="mega-menu__list"><a href="{{('/cart')}}" class="mega-menu__link">Cart</a></li>
                                                            <li class="mega-menu__list"><a href="{{('/checkout')}}" class="mega-menu__link">Checkout</a></li>
                                                            <li class="mega-menu__list"><a href="compare.html" class="mega-menu__link">Compare</a></li>
                                                            <li class="mega-menu__list pos-relative">
                                                                <a href="{{('/empty-cart')}}" class="mega-menu__link">Empty Cart</a>
                                                                <span class="menu-label menu-label--blue">New</span>
                                                            </li>
                                                            <li class="mega-menu__list"><a href="{{('/wishlist')}}" class="mega-menu__link">Wishlist</a></li>
                                                            <li class="mega-menu__list"><a href="{{('//my-account')}}" class="mega-menu__link">My Account</a></li>
                                                            <li class="mega-menu__list"><a href="{{('//login')}}" class="mega-menu__link">Login</a></li>
                                                        </ul>
                                                    </div>
                                                    <!--Single Megamenu Item Menu-->
                                                    ...
                                                    <div class="mega-menu__item-box">
                                                        ...
                                                        <ul class="mega-menu__item">
                                                            ...
                                                            <li class="mega-menu__list"><a href="{{('/product-single-affiliate')}}" class="mega-menu__link">Affiliate</a></li>
                                                            <li class="mega-menu__list pos-relative">
                                                        ...
                                                        <ul class="mega-menu__item">
                                                            ...
                                                            <li class="mega-menu__banner ">
                                                                <a href="product-single-default.html" class="mega-menu__banner-link">
                                                                    <img src="{{URL::asset('front')}}/assets/img/banner/menu-banner.jpg" alt="" class="mega-menu__banner-img mega-menu__banner-img--vertical">
                                                                </a>
                                                            </li>
                                                            <!--Megamenu Item Banner-->
                                                        </ul>
                                        ...
                                        <li class="header__nav-item pos-relative">
                                            ...
                                            <ul class="mega-menu pos-absolute">
                                                ...
                                                <li class="mega-menu__banner m-t-30">
                                                    <a href="product-single-default.html" class="mega-menu__banner-link">
                                                        <img src="{{URL::asset('front')}}/assets/img/banner/menu-banner-2.png" alt="" class="mega-menu__banner-img mega-menu__banner-img--horaizontal">
                                                    </a>
                                                </li>
                                                <!--Megamenu Item Banner-->
                                            </ul>
                                            ...
                                            <ul class="dropdown__menu pos-absolute">
                                                <li class="dropdown__list">
                                                    ...
                                                    <ul class="dropdown__submenu pos-absolute">
                                                        <li class="dropdown__submenu-list"><a href="{{('/blog-grid-sidebar-left')}}" class="dropdown__submenu-link"> Blog Grid Left Sidebar</a></li>
                                                ...
                                                <li class="dropdown__list">
                                                    ...
                                                    <ul class="dropdown__submenu pos-absolute">
                                                        <li class="dropdown__submenu-list"><a href="{{('/blog-single-sidebar-left')}}" class="dropdown__submenu-link"> Blog Single Left Sidebar</a></li>
                                        ...
                                        <li class="header__nav-item pos-relative">
                                            ...
                                            <!--Single Dropdown Menu-->
                                            <ul class="dropdown__menu pos-absolute">
                                                <li class="dropdown__list"><a href="{{('/about')}}" class="dropdown__link">About Us</a></li>
                                                <li class="dropdown__list pos-relative">
                                                    <a href="{{('/frequently-questions')}}" class="dropdown__link">Frequently Questions</a>
                                                    <span class="menu-label menu-label--blue">New</span>
                                                </li>
                                                <li class="dropdown__list"><a href="{{('/privacy-policy')}}" class="dropdown__link">Privacy Policy</a></li>
                                                <li class="dropdown__list"><a href="{{('/error')}}" class="dropdown__link">404 Page</a></li>
                                            </ul>
                                            <!--Single Dropdown Menu-->
                                        </li> <!-- End Single Nav link-->
                            ...
                            <li>
                                <div class="header__mobile-logo">
                                    <a href="index.html" class="header__mobile-logo-link">
                                        <img src="{{URL::asset('front')}}/assets/img/logo/logo.png" alt="" class="header__mobile-logo-img">
                                    </a>
                                </div>
                            </li>
                        </ul>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="{{('/shop-sidebar-grid-left')}}">Grid Left Sidebar</a></li>
                                        <li><a href="{{('/shop-sidebar-grid-right')}}">Grid Right Sidebar</a></li>
                            ...
                            <ul class="sub-menu">
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="{{('/product-single-affiliate')}}">Affiliate</a></li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <a href="#">Blog Grid</a>
                                    <ul class="sub-menu">
                                        <li><a href="{{('/blog-grid-sidebar-left')}}"> Blog Grid Left Sidebar</a></li>
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="{{('/blog-single-sidebar-left')}}"> Blog Single Left Sidebar</a></li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="{{('/frequently-questions')}}">Frequently Questions</a></li>
        ...
        <div  id="offcanvas-add-cart__box" class="offcanvas offcanvas-cart offcanvas-add-cart">
            ...
            <ul class="offcanvas-add-cart__menu">
                ...
                <li class="offcanvas-add-cart__list pos-relative d-flex align-items-center justify-content-between ">
                    <div class="offcanvas-add-cart__content d-flex align-items-start m-r-10">
                        <div class="offcanvas-add-cart__img-box pos-relative">
                            <a href="product-single-default.html" class="offcanvas-add-cart__img-link img-responsive"><img src="{{URL::asset('front')}}/assets/img/product/size-small/product-home-1-img-1.jpg" alt="" class="add-cart__img"></a>
                ...
                <li class="offcanvas-add-cart__list pos-relative d-flex align-items-center justify-content-between">
                    <div class="offcanvas-add-cart__content d-flex  align-items-start m-r-10">
                        <div class="offcanvas-add-cart__img-box pos-relative">
                            <a href="product-single-default.html" class="offcanvas-add-cart__img-link img-responsive"><img src="{{URL::asset('front')}}/assets/img/product/size-small/product-home-1-img-2.jpg" alt="" class="add-cart__img"></a>
                            <span class="offcanvas-add-cart__item-count pos-absolute">2x</span>
                        </div>
                        <div class="offcanvas-add-cart__detail">
                            <a href="product-single-default.html" class="offcanvas-add-cart__link">Lucky Wooden Elephant</a>
