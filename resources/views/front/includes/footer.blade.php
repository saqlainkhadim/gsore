 ...
 <footer class="footer m-t-100">
                        ...
                        <div class="footer__about">
                            <div class="footer__logo">
                                <a href="index.html" class="footer__logo-link">
                                    <img src="{{URL::asset('front')}}/assets/img/logo/logo.png" alt="" class="footer__logo-img">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="footer__payment">
                            <a href="#" class="footer__payment-link">
                                <img src="{{URL::asset('front')}}/assets/img/company-logo/payment.png" alt="" class="footer__payment-img">
                            </a>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="modal__product-img">
                                        <img class="img-fluid" src="{{URL::asset('front')}}/assets/img/product/size-normal/product-home-1-img-1.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-md-8">
    ...
    <!-- Vendor JS Files -->
    <script src="{{URL::asset('front')}}/assets/js/vendor/jquery-3.5.1.min.js"></script>
    <script src="{{URL::asset('front')}}/assets/js/vendor/modernizr-3.7.1.min.js"></script>
    <script src="{{URL::asset('front')}}/assets/js/vendor/jquery-ui.min.js"></script>
    <script src="{{URL::asset('front')}}/assets/js/vendor/bootstrap.bundle.min.js"></script>

    <!-- Plugins JS Files -->
    <script src="{{URL::asset('front')}}/assets/js/plugin/slick.min.js"></script>
    <script src="{{URL::asset('front')}}/assets/js/plugin/jquery.countdown.min.js"></script>
    <script src="{{URL::asset('front')}}/assets/js/plugin/material-scrolltop.js"></script>
    <script src="{{URL::asset('front')}}/assets/js/plugin/price_range_script.js"></script>
    <script src="{{URL::asset('front')}}/assets/js/plugin/in-number.js"></script>
    <script src="{{URL::asset('front')}}/assets/js/plugin/jquery.elevateZoom-3.0.8.min.js"></script>
    <script src="{{URL::asset('front')}}/assets/js/plugin/venobox.min.js"></script>
    <script src="{{URL::asset('front')}}/assets/js/plugin/jquery.waypoints.js"></script>
    <script src="{{URL::asset('front')}}/assets/js/plugin/jquery.lineProgressbar.js"></script>
