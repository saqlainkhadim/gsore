            ...
            <div class="row flex-column-reverse flex-lg-row">
                                ...
                                <div class="col-12">
                                    <div class="sidebar__banner">
                                        <a href="product-single-default.html" class="banner__link text-center">
                                            <img class="img-fluid" src="{{URL::asset('front')}}/assets/img/banner/size-port/img-sidebar.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul class="sidebar__post-product list-space--medium ">
                                <li  class="d-flex align-items-center">
                                    <a href="product-single-default.html" class="sidebar__product-img img-responsive">
                                        <img class="product__img img-fluid" src="{{URL::asset('front')}}/assets/img/product/size-small/product-home-1-img-1.jpg" alt="">
                                    </a>
                                ...
                                <li  class="d-flex align-items-center">
                                    <a href="product-single-default.html" class="sidebar__product-img img-responsive">
                                        <img class="product__img img-fluid" src="{{URL::asset('front')}}/assets/img/product/size-small/product-home-1-img-2.jpg" alt="">
                                    </a>
                                ...
                                <li  class="d-flex align-items-center">
                                        <a href="product-single-default.html" class="sidebar__product-img img-responsive">
                                            <img class="product__img img-fluid" src="{{URL::asset('front')}}/assets/img/product/size-small/product-home-1-img-3.jpg" alt="">
                                        </a>
                                    <!-- Start Product Content -->
                                    <div class="product__content">
                ...
                <div class="col-lg-9">
                    <div class="img-responsive">
                        <img src="{{URL::asset('front')}}/assets/img/banner/size-wide/banner-shop-1-img-1-wide.jpg" alt="">
                    </div>
