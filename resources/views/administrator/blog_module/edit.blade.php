        ...
        <div class="panel panel-default card-view">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                   <a href="{{route('admin_blog')}}" class="btn btn-danger">Go Back</a>
                </div>
            </div>
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-wrap">
                                {{ Form::open(array('url' => route('admin_blog_edit_store'), 'data-toggle'=>'validator' , 'class'=> 'form-horizontal', 'enctype'=>'multipart/form-data')) }}
                                    <input type="hidden" name="category_id" value="{{$select->id}}">
                                <div class="form-body">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="cat_id" class="form-control" required>
                                                            ...
                                                            @foreach($category as $cat)
                                                                <option value="{{$cat->id}}" @if($cat->id == $select->cat_id) selected @endif >{{$cat->title}}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('cat_id')
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <img src="{{asset('/backend/uploads/blog/'.$select->image)}}" alt="blog" width="100px">
