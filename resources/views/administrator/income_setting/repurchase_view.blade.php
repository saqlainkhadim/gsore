        ...
        <div class="panel panel-default card-view">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                   <a href="{{route('admin_repurchase')}}" class="btn btn-danger">Go Back</a>
                </div>
            </div>
            <div class="card-body">
                <h3>Repurchase</h3>
                {{ Form::open(array('url' => route('admin_repurchaseUpdate'), 'data-toggle'=>'validator' , 'class'=> 'form-horizontal', 'enctype'=>'multipart/form-data')) }}
