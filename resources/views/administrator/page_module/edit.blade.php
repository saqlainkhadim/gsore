    ...
    <div class="col-md-12">
        <div class="panel panel-default card-view">
            <div class="panel-heading">
                <div class="pull-left">
                    <h6 class="panel-title txt-dark">Edit Page</h6>
                </div>
            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-wrap">
                                {{ Form::open(array('url' => route('admin_page_edit_store'), 'data-toggle'=>'validator' , 'class'=> 'form-horizontal', 'enctype'=>'multipart/form-data')) }}
                                    <input type="hidden" name="page_id" value="{{$select->id}}">
                                <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="title" placeholder="Page name" value="{{$select->title}}" required>
                                                        @error('title')
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <img src="{{asset('/backend/uploads/page/'.$select->image)}}" alt="page" width="100px">
