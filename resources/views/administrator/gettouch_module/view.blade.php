    ...
    <div class="col-md-12">
        <div class="panel panel-default card-view">
            <div class="panel-heading">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Get In Touch View</h6>
                    </div>
                    <div class="pull-right">
                       <a href="{{route('admin_contact_us')}}" class="btn btn-danger">Go Back</a>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p class="form-control-static"> {{$select->subject}} </p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
