        ...
        <div class="panel panel-default card-view">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                   <a href="{{route('admin_product')}}" class="btn btn-danger">Go Back</a>
                </div>
            </div>
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-wrap">
                                {{ Form::open(array('url' => route('admin_product_edit_update'), 'data-toggle'=>'validator' , 'class'=> 'form-horizontal', 'enctype'=>'multipart/form-data')) }}
                                        ...
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="name" placeholder="Category name" value="{{$select->name}}" required>
                                                        @error('name')
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    <label for="inputName" class="control-label col-md-3">Price </label>
                                                    <div class="col-md-9">
                                                    <input type="text" class="form-control" name="price" placeholder="Price name  " value="{{$select->price}}" required>
                                                        @error('description')
                                                            <div class="alert alert-danger alert-dismissable alert-style-1">
                                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                                                <i class="zmdi zmdi-block"></i>{{ $message }}
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <img src="{{asset('/backend/uploads/product/'.$select->image)}}" alt="category" width="100px">
