...
dataTable = $('#all_customer').DataTable({
    responsive: true,
    serverSide: true,
    "oLanguage": {
    ...
    "ajax": {
        ...
        url: BASE_URL + '/administrator/all-customer-list/getallCustomerData',
        type: "post",
        error: function() {
            $(".user-table-error").html("");
            $("#all_customer").append('<tbody class="user-table-error"><tr><th colspan="7">No data found in the server</th></tr></tbody>');
        }
    },
