...
dataTable = $('#admin_as_seen_no').DataTable({
        responsive: true,
		serverSide: true,
		"oLanguage": {
    ...
    "ajax":{
        ...
        url : BASE_URL+'/administrator/gallery/getGalleryData',
        type: "post",
        error: function(){
            $(".user-table-error").html("");
            $("#admin_as_seen_no").append('<tbody class="user-table-error"><tr><th colspan="7">No data found in the server</th></tr></tbody>');
        }
    },
