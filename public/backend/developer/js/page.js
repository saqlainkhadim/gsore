...
dataTable = $('#page_list').DataTable({
    ...
    "ajax":{
        ...
        url : BASE_URL+'/administrator/page/getPageData',
        type: "post",
        error: function(){
            $(".user-table-error").html("");
            $("#page_list").append('<tbody class="user-table-error"><tr><th colspan="7">No data found in the server</th></tr></tbody>');
        }
    },
