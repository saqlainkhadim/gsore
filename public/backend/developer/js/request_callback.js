...
dataTable = $('#request_callback').DataTable({
        responsive: true,
		serverSide: true,
		"oLanguage": {
    ...
    "ajax":{
        ...
        url : BASE_URL+'/administrator/callback-request/getCallbackData',
        type: "post",
        error: function(){
            $(".user-table-error").html("");
            $("#request_callback").append('<tbody class="user-table-error"><tr><th colspan="7">No data found in the server</th></tr></tbody>');
        }
    },
