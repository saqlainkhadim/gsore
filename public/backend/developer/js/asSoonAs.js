...
dataTable = $('#gallery_list').DataTable({
        responsive: true,
		serverSide: true,
		"oLanguage": {
    ...
    "ajax":{
        ...
        url : BASE_URL+'/administrator/as-seen-no/getGalleryData',
        type: "post",
        error: function(){
            $(".user-table-error").html("");
            $("#gallery_list").append('<tbody class="user-table-error"><tr><th colspan="7">No data found in the server</th></tr></tbody>');
        }
    },
